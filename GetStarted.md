...
[`POST /companies/`](/services/services.md#post_companies)

#### 2. Ask for an IBAN ####

[`PUT /companies/-{id}/iban`](/services/services.md#put_companiesIban)
...
[`PUT /companies/-{id}/projectComplete`](/services/services.md#put_companiesComplete)
...
#### 4. Retrieve your certificate of deposit ####
 ...
 [`GET /companies/-{id}/document/certificateDeposit/`](/services/services.md#getDocuments_certificateIncorporation)
 
You can use either this API service, a FTP server or a tailor-made webhook to retrieve your certificate of deposit.

#### 5. Upload your Kbis ####

 [`PUT /companies/-{id}/document/certificateIncorporation`](/services/services.md#put_companiesCertificateIncorporation) 
...
[`PUT /companies/-{id}/releaseDeposit`](/services/services.md#put_companiesReleaseDeposit)
...
[`GET /companies/-{id}/`](/services/services.md#get_companies) 
...
#### XX. Update information in your project ####
 ...
 [`PUT /companies/-{id}/`](/services/services.md#put_companies)
...
[`DELETE /companies/-{id}/`](/services/services.md#delete_companies)
