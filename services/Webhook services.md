...
## New Version of the WebHook Documentation ##

First of all, if you want ot recieve webhook notification from this API, you must configure your endpoint in the settings section.

### Notification ###

This is the list of the different status you can have for a notification

| Event | Description |
|-------|-------------|
| documentToUpload | You need to upload this document for a specific compagny |
| statusChange | The status of a specific compagny has change |
| transfertAccepted | A funder transfert has been accepted |
| transfertRefused | A funder transfert has been rejected |
| transfertToValidate | A funder tranfert need a validation |
| KYCRefused | A KYC have been refused for a specifie compagny |

### Prototype of a webhook Object you will recieve  ###

#### Note ####

In this exemple, you will have all the diffrent representation of each event.


| Field | In | Type  | Description |
|-------|------|------|-------------|
| requestId | Body | [ID](../conventions/formattingConventions.md#type_id) | The unique ID for a webhook payload |
| date | Body | Date | The sent date of this payload | 
| notifications | Body | Array<Notification> | All the notifications for this payload | 
...
```js
{
    ...
    "notifications" [
        {
            //Common info for every event
            "eventId": "NTMMATcw",
            "compagnyCreationId": "NFTYMTcw",
            "date":"2017-04-25 14:06:25",
            "type":"statusChange",
            "firstSentDate":"2017-04-25 14:06:25",
            "lastSentDate":"2017-04-25 14:06:25",
            //Optional info, depends of type fields
            "documentId":null,
            "status":"waitingKYC",
            "transferId":null,
            "refusedFields":null
...
Here is the list of the different status you can have for a compagny creation

| Status | Description |
|-------|-------------|
| registration | You start a registration for the compagny creation service |
| awaitingFunds | You have completed the registration |
| fundsApproval | The funds from the different funders have been approved |
| iBanFirstAnalysis | iBanFirst analyse your request |
| rejected | Your request have been rejected |
| awaitingKBIS | The certificate of deposit is available, we waiting for you to upload your KBIS |
| checkKBIS | iBanFirst check your KBIS and the associated data  |
| refusedKBIS | Your KBIS have been refused |
| releaseOfFunds | Your deposit found waiting for liberation |
| fundsReleased | Your deposit found have been released |
| refusedDueToAnalysis | Your request have been refused due to analysis |
